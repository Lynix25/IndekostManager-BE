...
public class ServiceService {
    ...
    private void initializeService() {
    	...
    	jdbcTemplate.update("INSERT IGNORE INTO service (" + insertKeyAuditData + "service_name, variant) VALUES ('e2e295f3-e3e4-11ed-a584-00155ddd50f3', " + insertValueAuditData + "(SELECT name from master_service WHERE id = 1), 'Lainnya')");
    	jdbcTemplate.update("INSERT IGNORE INTO service (" + insertKeyAuditData + "service_name, variant) VALUES ('e2e293f1-e3e4-11ed-a584-00155ddd50f3', " + insertValueAuditData + "(SELECT name from master_service WHERE id = 2), 'Lainnya')");
