...
//    @PostConstruct
	void initializeData() {
        ...
        table = "announcement ";
        data = new ArrayList<>();
        data.add("('db791b5c-c91c-11ed-821e-00059a3c7a00', 'system', 1679536129, 'system', 1679536129, 'Book a room for a week and get a free meal voucher for the Cat\\'s Tail Tavern.', NULL, 'April 20 - May 10', 'Special Offer for Travelers')");
        data.add("('db79441a-c91c-11ed-821e-00059a3c7a00', 'system', 1679536129, 'system', 1679536129, 'Our deluxe single rooms are now fully booked, but we still have standard double rooms available for rent.', NULL, 'May 1 - May 31', 'Room Availability Update')");
        data.add("('db79727c-c91c-11ed-821e-00059a3c7a00', 'system', 1679536129, 'system', 1679536129, 'We will be conducting maintenance works from 9am to 5pm. Water and electricity supply may be temporarily interrupted during this period.', NULL, 'May 15', 'Maintenance Notice')");
        data.add("('db799a0a-c91c-11ed-821e-00059a3c7a00', 'system', 1679536129, 'system', 1679536129, 'All guests are reminded to clean up after themselves and not to make excessive noise after 10pm.', NULL, 'Ongoing', 'House Rules Reminder')");
        data.add("('db79c1c8-c91c-11ed-821e-00059a3c7a00', 'system', 1679536129, 'system', 1679536129, 'Book our package deal and get a discounted rate for entrance tickets to the nearby Thousand Wind Temple.', NULL, 'May 1 - June 30', 'Tourist Attraction Package')");
        ...
        table = "room ";
        data = new ArrayList<>();
        data.add("('814bf6b7-de02-11ed-9bfd-00155dee1635', 'system', 1679536129, 'system', 1679536129, 'Putra', 'Kamar khusus putra.', 1, 0, 'Kamar 101', 2)");
        data.add("('bc34fae6-de8a-11ed-9bfd-00155dee1635', 'system', 1679536129, 'system', 1679536129, 'Putri', 'Kamar khusus putri.', 1, 0, 'Kamar 102', 4)");
        data.add("('c1c2624a-de8a-11ed-9bfd-00155dee1635', 'system', 1679536129, 'system', 1679536129, 'Putri', 'Kamar khusus putri.', 1, 0, 'Kamar 103', 2)");
        ...
        /* ============================== ROOM DETAIL ============================== */
        columnList = "(`id`, `description`, `enable`, `name`, `detail_category_id`, `room_id`)";
        table = "room_detail ";
        data = new ArrayList<>();
        data.add("(1, '4 x 5 meter', 1, 'Luas Ruangan', 1, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(2, '800 watt', 1, 'Listrik', 1, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(3, 'Single bed 2 unit', 1, 'Kasur', 1, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(4, '2 buah', 1, 'Bantal', 1, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(5, '2 buah', 1, 'Guling', 1, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(6, 'Di dalam kamar', 1, 'Kamar Mandi Dalam', 2, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(7, NULL, 0, 'Kloset Jongkok', 2, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(8, NULL, 1, 'Kloset Duduk', 2, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(9, NULL, 1, 'Kran', 2, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(10, 'Shower panjang dan pendek', 1, 'Shower', 2, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(11, 'Tersedia', 1, 'Air Panas', 2, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(12, NULL, 0, 'Bak Mandi', 2, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(13, '1 buah', 1, 'Wastafel', 2, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(14, '1 buah', 1, 'Cermin', 2, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(15, '2 unit', 1, 'Lemari Baju', 3, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(16, '2 unit', 1, 'Meja', 3, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(17, '2 unit', 1, 'Kursi', 3, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(18, 'Kecepatan 20mbps', 1, 'WiFi', 4, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(19, '1 unit', 1, 'AC', 4, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(20, NULL, 0, 'Kipas Angin', 4, '814bf6b7-de02-11ed-9bfd-00155dee1635')");
        data.add("(21, '10 x 12 meter', 1, 'Luas Ruangan', 1, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(22, '1500 watt', 1, 'Listrik', 1, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(23, 'Single bed 4 unit', 1, 'Kasur', 1, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(24, '4 buah', 1, 'Bantal', 1, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(25, '4 buah', 1, 'Guling', 1, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(26, 'Di dalam kamar', 1, 'Kamar Mandi Dalam', 2, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(27, NULL, 0, 'Kloset Jongkok', 2, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(28, NULL, 1, 'Kloset Duduk', 2, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(29, NULL, 0, 'Kran', 2, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(30, 'Shower panjang dan pendek', 1, 'Shower', 2, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(31, 'Tersedia', 1, 'Air Panas', 2, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(32, NULL, 0, 'Bak Mandi', 2, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(33, '2 buah', 1, 'Wastafel', 2, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(34, '2 buah', 1, 'Cermin', 2, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(35, '4 unit', 1, 'Lemari Baju', 3, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(36, '4 unit', 1, 'Meja', 3, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(37, '4 unit', 1, 'Kursi', 3, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(38, 'Kecepatan 20mbps', 1, 'WiFi', 4, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(39, '1 unit', 1, 'AC', 4, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(40, NULL, 0, 'Kipas Angin', 4, 'bc34fae6-de8a-11ed-9bfd-00155dee1635')");
        data.add("(41, '4 x 5 meter', 1, 'Luas Ruangan', 1, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(42, '800 watt', 1, 'Listrik', 1, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(43, 'Single bed 2 unit', 1, 'Kasur', 1, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(44, '2 buah', 1, 'Bantal', 1, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(45, '2 buah', 1, 'Guling', 1, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(46, 'Di dalam kamar', 1, 'Kamar Mandi Dalam', 2, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(47, NULL, 0, 'Kloset Jongkok', 2, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(48, NULL, 1, 'Kloset Duduk', 2, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(49, NULL, 0, 'Kran', 2, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(50, 'Shower panjang dan pendek', 1, 'Shower', 2, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(51, 'Tersedia', 1, 'Air Panas', 2, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(52, NULL, 0, 'Bak Mandi', 2, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(53, '1 buah', 1, 'Wastafel', 2, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(54, '1 buah', 1, 'Cermin', 2, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(55, '2 unit', 1, 'Lemari Baju', 3, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(56, '2 unit', 1, 'Meja', 3, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(57, '2 unit', 1, 'Kursi', 3, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(58, 'Kecepatan 20mbps', 1, 'WiFi', 4, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(59, '1 unit', 1, 'AC', 4, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        data.add("(60, NULL, 0, 'Kipas Angin', 4, 'c1c2624a-de8a-11ed-9bfd-00155dee1635')");
        ...
        data.add("('e2e315f3-e3e4-11ed-a584-00155ddd50f3', 'system', 1683646619, 'system', 1683646619, 0, 0, 0, 0, 'Layanan Lainnya', NULL, 'Lainnya')");
        data.add("('e2e335f3-e3e4-11ed-a584-00155ddd50f3', 'system', 1683646619, 'system', 1683646619, 0, 0, 0, 0, 'Layanan Lainnya', NULL, 'Pindah Kamar')");
